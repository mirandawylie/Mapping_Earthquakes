...
// Create a second tile layer that will be the background of our map.
...
let mapDark = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/dark-v10/tiles/{z}/{x}/{y}?access_token={accessToken}', {
	attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery (c) <a href="https://www.mapbox.com/">Mapbox</a>',
	maxZoom: 18,
	accessToken: API_KEY
});
...
// Create a base layer that holds all three map layer styles.
let baseMaps = {
  "Streets": streets,
...
// Add 1st layer group for the all earthquake data.
let allEarthquakes = new L.LayerGroup();

// Add 2nd layer group for the tectonic plate data.
let tectonicPlates = new L.LayerGroup();

// Add 3nd layer group for the major earthquake data.
let majorEarthquakes = new L.LayerGroup();

// Add references to the overlays object
let overlays = {
...
//MAJOR EARTHQUAKE
  ...
  // Add the major earthquake layer to our map.
